...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "메챠 카멜레온 - 3D 멀티플레이 숨바꼭질" },
      { name: "description", content: "친구들과 함께 3D 공간에서 즐기는 멀티플레이 숨바꼭질. 방을 만들고 코드를 공유하세요." },
      { property: "og:title", content: "메챠 카멜레온" },
      { property: "og:description", content: "3D 멀티플레이 숨바꼭질 게임" },
